...
public class DBCategoryDao extends AbstractDao<DBCategory, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ImageUrl = new Property(2, Long.class, "imageUrl", false, "IMAGE_URL");
    ...
    protected void bindValues(SQLiteStatement stmt, DBCategory entity) {
        ...
        Long imageUrl = entity.getImageUrl();
        if (imageUrl != null) {
            stmt.bindLong(3, imageUrl);
        }
    ...
    public DBCategory readEntity(Cursor cursor, int offset) {
        DBCategory entity = new DBCategory( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2), // imageUrl
    ...
    public void readEntity(Cursor cursor, DBCategory entity, int offset) {
        ...
        entity.setImageUrl(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
